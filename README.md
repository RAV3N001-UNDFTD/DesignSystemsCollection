...
- [x] Token 基础层：DTCG 源 + Style Dictionary 管线 + default/dark 双主题 + 校验 CI → [tokens/](tokens/)
- [x] 第一套可套用设计系统 v0：shadcn 兼容 registry（4 base + 1 composed + 2 blocks，均带 AI 规则）→ [registry/](registry/)
